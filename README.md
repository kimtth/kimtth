...
- [azure-bicep-app-service-cosmos-db](https://github.com/kimtth/azure-bicep-app-service-cosmos-db): 🛡️Deploy secure Azure infra with **Bicep** (IaC): **Private Link** & Endpoints in a VNet 🖧🧱
- [azure-bot-active-learning-sync](https://github.com/kimtth/azure-bot-active-learning-sync): 👾 For syncing between the training data managed by manual and **auto-generate** data by **QnA maker**.
- [azure-concurrency-version-control-etag](https://github.com/kimtth/azure-concurrency-version-control-etag): A **concurrency-safe** ⚙️ Azure resource **ETags** (Entity Tag) 🏷️ for version control 🔄.
...
- [teams-speech-bot-plugin-azure](https://github.com/kimtth/teams-speech-bot-plugin-azure): 👺**Microsoft Teams** Speech Bot Demo
- [voice-translator-bot](https://github.com/kimtth/voice-translator-bot): 💬 🐳 Bot by **MERN** (React Hooks) Stack using Azure **Cognitive Service** (Speech to Text, Translate)

#### Datascience

- [ds-categorical-data-clustering](https://github.com/kimtth/ds-categorical-data-clustering): 🫧**clustering** for categorical data analysis. (precomputed pairwise matrix, **DBSCAN**, t-SNE)
- [ds-gradient-boosting-hands-on](https://github.com/kimtth/ds-gradient-boosting-hands-on): Top **Gradient Boosting** methods (**XGBoost**, LightGBM, CatBoost) 🌳
...
- [cisco-config-generator](https://github.com/kimtth/cisco-config-generator): 📝📋 **Cisco** Basic Router **Configuration Generator** is built using BottlePy
- [eggplant-ai-funtional-play](https://github.com/kimtth/eggplant-ai-funtional-play): 🌱🍄 **eggplant functional** & eggplant AI integrating with sense talk script
- [elasticsearch-dockerfile-analyzer](https://github.com/kimtth/elasticsearch-dockerfile-analyzer): 🐳 **docker-compose** for **elastic search** & kibana
- [hello-auto-robot-selenium](https://github.com/kimtth/hello-auto-robot-selenium): 👋🚘 [archived] **Test Automation** with **Selenium** and Robot Framework
- [hinemos-ntt-qualisystems](https://github.com/kimtth/hinemos-ntt-qualisystems): ㊙️ **Hinemos** Shell Draft
...
- [openstack-dev-cloudshell](https://github.com/kimtth/openstack-dev-cloudshell): 📚 **Openstack** intergration with Quali **Cloudshell**
- [tora-auto-ui-opencv](https://github.com/kimtth/tora-auto-ui-opencv): 🐯🌱 **UI Automation** By **OpenCV** (Image Template Matching). TORA (Tigre / Tiger)
...
- [ai-caption-admin](https://github.com/kimtth/ai-caption-admin): 🍥 **GraphQL**: Admin webpage for dashboard
...
- [mini-sqlite-engine-py-go-rust](https://github.com/kimtth/mini-sqlite-engine-py-go-rust): Learn **Rust** 🦀 & **Golang** 🔵 with a **Mini-SQLite** Database Engine 🏗️ (for Python users)
...
- [small-dsl-eclipse-debug](https://github.com/kimtth/small-dsl-eclipse-debug): 👀▶️ [archived] Exploring the Programming Languages Engineering, **Domain-Specific Language**, Integration with the **Eclipse Debug UI**, and the Fundamental Features of an Interpreter and Debugger.
...
- [xmpp-socketio-rabbitmq](https://github.com/kimtth/xmpp-socketio-rabbitmq): 🤺 Study for **messaging protocols**. **XMPP** with xmpp.js, Websocket with Socket.io, AMQP with RabbitMQ in Docker.
...
- [ms-build-learn-notes](https://github.com/kimtth/ms-build-learn-notes): 🪟🍭🖥️ A concise summary of **Microsoft's products** includes Azure, .NET, M365, **Power Platform**, Security, DevOps, Viva, and GitHub. The curricula are based on the Build 2023 challenge.
...
- [rag-minimum-azure-ai-search-sql-indexer](https://github.com/kimtth/rag-minimum-azure-ai-search-sql-indexer): Azure AI Search Index creation for FAQ retrieval. (**SQL Indexer**: pull & push) 🔍🤖💬
...
- [software-architect-mindmap](https://github.com/kimtth/software-architect-mindmap): 🧠**Mindmap** of 🗺️**Software Architecture**, Software engineering: An Overview of Software Terminologies and Concepts.
- [science-alpha-fold-note](https://github.com/kimtth/science-alpha-fold-note): 🧬 Notes about **AlphaFold** inputs, outputs, and **model architecture**
- [science-companion-mindmap](https://github.com/kimtth/science-companion-mindmap): 🧪References and notes for **science mindmap** — **College-level** science overview
- [science-general-relativity](https://github.com/kimtth/science-general-relativity): Note for 🌌 **General Relativity**, also known as the General Theory of Relativity 
...
- [chrome-extension-teams-msg-copy](https://github.com/kimtth/chrome-extension-teams-msg-copy): 🍿**Browser extension**: Microsoft Teams **message copy** helper. Pop!Pop!
...
- [ebook-viewer-epub-png](https://github.com/kimtth/ebook-viewer-epub-png): 📘📸 **Auto-capture** eBook pages using screen region, detect changes, and save images.
...
- [Freenove_4WD_Smart_Car_Kit_for_Raspberry_Pi](https://github.com/kimtth/Freenove_4WD_Smart_Car_Kit_for_Raspberry_Pi): [Note] **Troubeshooting** for FNK0043
- [geotiff-earthquake-extraction](https://github.com/kimtth/geotiff-earthquake-extraction): 🌏**Earthquake** metadata extraction from **GeoTIFF**🗺️ provided by Quiet+ API (Japan)
- [podcast-download-simple](https://github.com/kimtth/podcast-download-simple): A simple, **standalone HTML** file for 📥downloading 🎧**podcast** episodes. Just copy your podcast URL from podcastindex.org
