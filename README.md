...
[azure-bot-active-learning-sync](https://github.com/kimtth/azure-bot-active-learning-sync): **Sync** between manually managed training data and auto-generated data by **QnA Maker**.  
[azure-concurrency-version-control-etag](https://github.com/kimtth/azure-concurrency-version-control-etag): ️ **Concurrency-safe** Azure resource **ETags** (Entity Tag) for version control.  
...
[ai-pytorch-lighthouse-attention](https://github.com/kimtth/ai-pytorch-lighthouse-attention): **Lighthouse Attention** — small hackable implementation (arxiv.org/abs/2605.06554)   
[ai-pytorch-vis-llama-trial](https://github.com/kimtth/ai-pytorch-vis-llama-trial): **PyTorch** + **Llama** — getting started  
[ai-recursive-lang-model-inference](https://github.com/kimtth/ai-recursive-lang-model-inference): **Recursive Language Models** (RLMs) unofficial (arxiv.org/abs/2512.24601).  
[ai-twitter-recommender-mimic-mini-recsys](https://github.com/kimtth/ai-twitter-recommender-mimic-mini-recsys): Mini-Recsys: **Twitter Recommender** mimic ️  
[ai-voice-translator-bot](https://github.com/kimtth/ai-voice-translator-bot): **MERN** Stack bot using Azure **Cognitive Service** (Speech to Text, Translate)  
...
[ds-einsum-n-dimension](https://github.com/kimtth/ds-einsum-n-dimension): **Einsum** examples for **N-dimensional** tensor operations  
...
[ds-huggingface-wav2vec](https://github.com/kimtth/ds-huggingface-wav2vec): **wav2vec** — HuggingFace speech representation learning  
[ds-numpy-multi-dims-visualizer](https://github.com/kimtth/ds-numpy-multi-dims-visualizer): **D3.js-powered** web app to visualize and understand **multi-dimensional** NumPy arrays.  
...
[devops-eggplant-ai-funtional-play](https://github.com/kimtth/devops-eggplant-ai-funtional-play): **Eggplant** functional & Eggplant AI integrating with **SenseTalk** script  
...
[rag-ai-search-index-blob-trigger](https://github.com/kimtth/rag-ai-search-index-blob-trigger): **Azure AI Search index creation** triggered by Azure Function **Blob Trigger**  
...
[util-czur-bookscan-epub-manual](https://github.com/kimtth/util-czur-bookscan-epub-manual): **CZUR** book scan to **EPUB** conversion — memo  
